...
class Student  {
 public:
    ...
    virtual ~Student() {}
    virtual QString getClassName() const; /* Const member function is used when we want a function that should not be used to change the value of the data members (e.g. m_Name)
